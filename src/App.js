...
class App extends Component {
  ...
  componentDidMount() {
    this.searchVideoHandler('Full Video:Ankhiyon Se Goli Mare | Pati Patni Aur Woh | Kartik A, Bhumi P, Ananya P |Mika S, Tulsi K'); // for default will be guns and roses :>
  }
